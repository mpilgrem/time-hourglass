...
-- | Return the day of the week a specific date falls in.
getWeekDay :: Date -> WeekDay
getWeekDay date = toEnum (d `mod` 7)
 where
  d = daysOfDate date

-- | Return the number of days until the beggining of the month specified for a
-- specific year.
...
-- | Return the day of the year where Jan 1st is 0. Between 0 and 364 or 365 for
-- leap years.
...
-- | Return the number of seconds to Unix epoch of a date considering
